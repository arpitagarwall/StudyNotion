...
function Template({title, desc1, desc2, image, formtype, children,accountType,setAccountType}) {
  return (
    <div className='flex w-11/12 max-w-[1160px] py-12 justify-between mx-auto gap-x-12 gap-y-0'>
        ...
        <div className='w-11/12 max-w-[450px]'>
            ...
            {children}
            {formtype ==="signUp" ? (<SignUpForm accountType={accountType} setAccountType={setAccountType}></SignUpForm>) : (<LoginForm accountType={accountType} setAccountType={setAccountType}></LoginForm>)}
